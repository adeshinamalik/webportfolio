        ...
        <div className="grid md:grid-cols-[1fr_2fr] gap-12 items-start">
          ...
          <div className="space-y-8 animate-slide-left">
            <p className="text-muted-foreground leading-relaxed">
              I'm <b>Ahmed Malik</b>, a passionate Web Designer and Developer specializing in responsive, user-centric web applications. 
              With a background in Mechatronics and IoT, I’m delivering cutting-edge web and Web3 solutions for modern businesses. 
              I love creating impactful projects, leveraging technology to solve real-world problems.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              My journey into blockchain and Web3 allows me to bridge traditional web development with decentralized apps (dApps) and smart contracts. 
              I’m excited about building efficient, scalable solutions and collaborating with dynamic teams.
            </p>
            {/* Video introduction */}

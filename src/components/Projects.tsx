...
const projects: Project[] = [
  ...
  },
  {
    ...
    image: Images.innovativefarmers,
  ...
  },
  {
    "id": 6,
    "title": "Pet Palace",
    "description": "Pet Palace is a web platform for pet and farm animal owners in Nigeria, offering e-commerce for pet supplies and farm equipment, service bookings, adoption/trading, and community engagement.",
    "image": Images.petpalace,
    "tags": ["pets", "farm animals", "Nigeria", "e-commerce", "pet care", "livestock", "community"],
    "github": "https://github.com/adeshinamalik/pet-palace-nigeria",
    "demo": "https://pet-palace-nigeria.vercel.app/",
    "type": "web2"
  }
];
    ...
    >
      <div className="relative aspect-video overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
          <div>
            <span className={`text-xs px-2 py-1 rounded-full ${project.type === 'web3' ? 'bg-neon-purple/20 text-neon-purple' : 'bg-neon-blue/20 text-neon-blue'
              }`}>
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm transition-all ${filter === "all"
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm transition-all ${filter === "web2"
                ? "glass-morphism hover:bg-white/10 neon-box"
                : "neo-blur hover:bg-white/5"
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm transition-all ${filter === "web3"
                ? "glass-morphism hover:bg-white/10 neon-box"
                : "neo-blur hover:bg-white/5"
                }`}
            >
